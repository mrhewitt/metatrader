...
//---
   ...
   if ( countdown > 0 && countdown < 999 ) {
      ...
      if ( countdown == 0 ) {
         ...
         double LegSize = MathMax(NormalizeDouble((atr / point) * ATRMultiplier,1), MinLegSize);
         ...
         placeOrder(ORDER_TYPE_BUY_STOP, LegSize, volume);
         placeOrder(ORDER_TYPE_SELL_STOP, LegSize, volume);
      }
    }
  }
//+------------------------------------------------------------------+
